...
def main():
    ...
    flag("VERIFIED_PASS_2026_09_11", "Superseded-pass note kept for the audit trail: 2026-09-11 MLB Stats "
         ...
         "days, not data gaps.")
    flag("VERIFIED_PASS_2026_09_17_D",
         "2026-09-17 pass D (independent re-verification of every online source, ZERO DRIFT found): "
         "(1) MLB Stats API postseason query re-fetched live (all 9 chunks, gamePk level): 53 games "
         "across the same 28 dates; head (Sep 29: 849851/849843/849849/849845), middle (Oct 3-5) and "
         "tail (WS Oct 26-31: 849804/849803/849799/849801/849800) all match "
         "data/raw/mlb_2026_postseason_tbd.txt; every game still startTimeTBD=true with the 07:33:00Z "
         "placeholder - NO 2026 postseason kickoff time is official yet. (2) mlb.com/postseason "
         "re-fetched: all Wild Card + Division Series gamePks print 'TBD' start times (NBC/Peacock "
         "WC, TBS ALDS, FOX NLDS). (3) mlb.com playoff picture re-fetched: the SAME 4 clinches "
         "(Rays, Brewers, Dodgers, Yankees) and the same projected bracket as recorded - zero "
         "changes today. (4) NBC's own Wild Card explainer (nbc.com, Sep 14, 2026) confirms 'Times "
         "and teams are still TBD' - the 2025-pattern EST windows stay correctly labeled estimates. "
         "(5) WWO NFL page re-fetched (all 4 chunks): all 65 dated broadcasts + 8 TBA placeholders "
         "match the raw file at event-id level - zero deltas (WAS@SF Oct 19, SF@LAC Dec 17, "
         "PHI@SF Jan 3 SNF unchanged). (6) WWO NCAAF eventGrid endpoint re-fetched: same 13 "
         "broadcasts, zero deltas. (7) WWO NCAA Basketball page: 'No upcoming events' (unchanged). "
         "(8) 49ers.com schedule re-fetched: 20/20 rows match, incl. Oct 19 WAS 5:15 PM PDT, "
         "Nov 22 MIN 5:20 PM PST (Estadio Banorte), Dec 17 @LAC 5:15 PM PST, Jan 3 PHI 5:20 PM "
         "PST SNF, Wk18 @ARI TBD; per-game radio rows (KSFO 810 weeks 2-3, then KSAN 107.7 + KNBR "
         "104.5/680) unchanged. (9) gostanford.com football re-fetched: 12/12 rows match (remaining "
         "TBAs: Oct 3, Oct 31, Nov 14, Nov 21 Big Game, Nov 28). (10) calbears.com football "
         "re-fetched: 12/12 rows match; 'Radio: KSFO 810 AM' on every game, 'Radio: KNBR 104.5 FM / "
         "680 AM' on the Nov 21 Big Game (unchanged). (11) sjearthquakes.com printable schedule "
         "links the same official 2026 PDF the repo transcribed (zero drift; the Oct 31 2:00 PM PT "
         "correction from the club radio release stands). (12) ESPN site API spot-check: Warriors "
         "regular-season opener event 401909092 GS@LAL 2026-10-22T02:00Z = Oct 21, 7:00 PM PT "
         "matches the raw row exactly. (13) Stanford MBB + Cal MBB 2026-27 schedules located (all "
         "tipoff times TBA) - radio verdicts in MBB_RADIO_NOT_OTA. (14) NEW scripts/fetch_mlb.py: "
         "one-command live re-check of the MLB postseason (per-gamePk + per-date diff vs the raw "
         "file, official-time detection, snapshot JSON; graceful offline no-op) - run it after the "
         "field is set Sep 27-28.")
    flag("MBB_RADIO_NOT_OTA",
         "IRREGULARITY / RESEARCH CORRECTION 2026-09-17 (Stanford + Cal MEN'S BASKETBALL radio): "
         "the 2026-09-17 pass C note suggested ~30 Stanford MBB games air on KNBR 1050 AM. The "
         "current-era evidence CONTRADICTS over-the-air carriage: gostanford.com's own release "
         "'Enhanced Basketball Coverage' (Nov 9, 2017) states men's basketball broadcasts 'will "
         "shift FROM KNBR 1050 AM, which had previously served as the flagship network' to free "
         "online audio (GoStanford.com/SIDEARM + TuneIn, select games on SiriusXM). The KNBR-1050 "
         "flagship claims that remain online (2011/2013 gostanford.com releases, third-party "
         "radio directories) predate that shift. Cal MBB: calbears.com's 2026-27 schedule page "
         "prints NO radio rows (football games all print one - so the omission is meaningful); "
         "no current Bay Area OTA flagship found. DECISION (no-hallucination rule): Stanford MBB "
         "and Cal MBB are NOT added as blocking radio leagues. Games are still not free-time-"
         "relevant unless/until an over-the-air flagship is verified per game (check each game "
         "note when gameday releases return in November). Sources: gostanford.com/news/2017/11/09/"
         "enhanced-basketball-coverage; gostanford.com/news/2011/05/03/knbr-1050-named-stanfords-"
         "flagship-radio-partner; gostanford.com/news/2013/4/17/radio-information; calbears.com/"
